...
// run fight function to start gamefor (var i = 0; i < enemyNames.length; i ++) {
...
if (playerHealth > 0) {
    ...
    // pass the pickedEnemyName variable's value into the fight function, where it willassume the value of the enemyName parameter
